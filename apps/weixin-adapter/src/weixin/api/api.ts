...
import { parseWeixinJson } from "./json.mjs";
...
interface PackageJson {
  ...
  version?: string;
  ilink_appid?: string;
  weixin_protocol_version?: string;
}
...
const CHANNEL_VERSION = pkg.weixin_protocol_version ?? pkg.version ?? "unknown";
...
export async function getUpdates(
  ...
  try {
    ...
    const resp: GetUpdatesResp = parseWeixinJson(rawText);
    return resp;
  } catch (err) {
...
export async function getUploadUrl(
  ...
  const resp: GetUploadUrlResp = parseWeixinJson(rawText);
  return resp;
}
...
export async function sendMessage(
  ...
  const resp: SendMessageResp = parseWeixinJson(rawText);
...
export async function getConfig(
  ...
  const resp: GetConfigResp = parseWeixinJson(rawText);
  return resp;
}
...
export async function notifyStop(params: WeixinApiOptions): Promise<NotifyStopResp> {
  ...
  return parseWeixinJson(rawText) as NotifyStopResp;
}
...
export async function notifyStart(params: WeixinApiOptions): Promise<NotifyStartResp> {
  ...
  return parseWeixinJson(rawText) as NotifyStartResp;
}
